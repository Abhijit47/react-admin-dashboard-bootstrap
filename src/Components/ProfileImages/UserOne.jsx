...
const UserOne = () => {
  return (
    ...
    <svg version="1.1" id="_x38_8ce59e9-c4b8-4d1d-9d7a-ce0190159aa8"
      xmlns="http://www.w3.org/2000/svg" xmlnsXlink="http://www.w3.org/1999/xlink" x="0px" y="0px" viewBox="0 0 231.8 231.8"
      style={{ enableBackground: "new 0 0 231.8 231.8;" }} xmlSpace="preserve">
      <style type="text/css">
        .st0{{ opacity: "0.5;" }}
        ...
        .st3{{ fill: "#333333;" }}
        .st4{{ fill: "#4E73DF;" }}
        .st5{{ opacity: "0.1;", enableBackground: "new;" }}
        .st6{{ fill: "#BE7C5E" }}
      </style>
      <g class="st0">
